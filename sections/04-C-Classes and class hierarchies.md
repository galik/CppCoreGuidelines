...
* [define a class with private data as `class`](04-C-Classes%20and%20class%20hierarchies.md#Rc-class)
* [Prefer to place the interface first in a class](21-NL-Naming%20and%20layout%20rules.md#Rl-order)
* [minimize exposure of members](04-C-Classes%20and%20class%20hierarchies.md#Rc-private)
* [Avoid `protected` data](04-C-Classes%20and%20class%20hierarchies.md#Rh-protected)
...
* [C.43: Ensure that a copyable (value type) class has a default constructor](04-C-Classes%20and%20class%20hierarchies.md#Rc-default0)
...
* [C.67: A polymorphic class should suppress copying](04-C-Classes%20and%20class%20hierarchies.md#Rc-copy-virtual)
...
```
Alternatively to prevent slicing as per [C.67](04-C-Classes%20and%20class%20hierarchies.md#Rc-copy-virtual),
...
**See also**: [construct valid object](04-C-Classes%20and%20class%20hierarchies.md#Rc-complete) and [constructor throws](04-C-Classes%20and%20class%20hierarchies.md#Rc-throw).
...
A [value type](04-C-Classes%20and%20class%20hierarchies.md#SS-concrete) is a class that is copyable (and usually also comparable).
...
If you need to create deep copies of polymorphic objects, use `clone()` functions: see [C.130](04-C-Classes%20and%20class%20hierarchies.md#Rh-copy).
...
* [C.130: For making deep copies of polymorphic classes prefer a virtual `clone` function instead of copy construction/assignment](04-C-Classes%20and%20class%20hierarchies.md#Rh-copy)
...
```
Generally, it is recommended to use smart pointers to represent ownership (see [R.20](06-R-Resource%20management.md#Rr-owner)). However, because of language rules, the covariant return type cannot be a smart pointer: `D::clone` can't return a `unique_ptr<D>` while `B::clone` returns `unique_ptr<B>`. Therefore, you either need to consistently return `unique_ptr<B>` in all overrides, or use `owner<>` utility from the [Guidelines Support Library](20-GSL-Guidelines%20support%20library.md#SS-views).
...
* [C.160: Define operators primarily to mimic conventional usage](04-C-Classes%20and%20class%20hierarchies.md#Ro-conventional)
...
* [C.168: Define overloaded operators in the namespace of their operands](04-C-Classes%20and%20class%20hierarchies.md#Ro-namespace)
* [C.170: If you feel like overloading a lambda, use a generic lambda](04-C-Classes%20and%20class%20hierarchies.md#Ro-lambda)
...
```
Here, the conventional semantics is maintained: [Copies compare equal](04-C-Classes%20and%20class%20hierarchies.md#SS-copy).
...
This is a special case of the rule that [helper functions should be defined in the same namespace as their class](04-C-Classes%20and%20class%20hierarchies.md#Rc-helper).
...
* [C.180: Use `union`s to save Memory](04-C-Classes%20and%20class%20hierarchies.md#Ru-union)
* [C.181: Avoid "naked" `union`s](04-C-Classes%20and%20class%20hierarchies.md#Ru-naked)
* [C.182: Use anonymous `union`s to implement tagged unions](04-C-Classes%20and%20class%20hierarchies.md#Ru-anonymous)
* [C.183: Don't use a `union` for type punning](04-C-Classes%20and%20class%20hierarchies.md#Ru-pun)
* ???
...
```
But heed the warning: [Avoid "naked" `union`s](04-C-Classes%20and%20class%20hierarchies.md#Ru-naked)
