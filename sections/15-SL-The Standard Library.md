...
* [SL.str.1: Use `std::string` to own character sequences](15-SL-The%20Standard%20Library.md#Rstr-string)
...
`std::string` supports standard-library [`locale` facilities](15-SL-The%20Standard%20Library.md#Rstr-locale)
