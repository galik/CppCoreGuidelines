...
* [SF.10: Avoid dependencies on implicitly `#include`d names](S-17-Source%20files.md#Rs-implicit)
...
Our recommendation is to write in ISO C++: See [rule P.2](S-03-Philosophy.md#Rp-Cplusplus).
