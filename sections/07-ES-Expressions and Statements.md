...
For initializers of moderate complexity, including for `const` variables, consider using a lambda to express the initializer; see [ES.28](07-ES-Expressions%20and%20Statements.md#Res-lambda-init).
