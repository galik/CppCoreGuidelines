...
**See also**: [precondition rule](S-04-Interfaces.md#Ri-pre).
...
**See also**: [postcondition rule](S-04-Interfaces.md#Ri-post).
...
[discussion](S-28-Discussion.md#Sd-noexcept).
...
**See also**: [discussion](S-28-Discussion.md#Sd-never-fail)
...
**See also**: [Returning multiple values](S-05-Functions.md#Rf-out-multi).
...
For example, see [Stroustrup94](S-31-Bibliography.md#Stroustrup94).
