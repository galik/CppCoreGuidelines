...
* [P.1: Express ideas directly in code](S-03-Philosophy.md#Rp-direct)
* [P.2: Write in ISO Standard C++](S-03-Philosophy.md#Rp-Cplusplus)
* [P.3: Express intent](S-03-Philosophy.md#Rp-what)
* [P.4: Ideally, a program should be statically type safe](S-03-Philosophy.md#Rp-typesafe)
* [P.5: Prefer compile-time checking to run-time checking](S-03-Philosophy.md#Rp-compile-time)
* [P.6: What cannot be checked at compile time should be checkable at run time](S-03-Philosophy.md#Rp-run-time)
* [P.7: Catch run-time errors early](S-03-Philosophy.md#Rp-early)
* [P.8: Don't leak any resources](S-03-Philosophy.md#Rp-leak)
* [P.9: Don't waste time or space](S-03-Philosophy.md#Rp-waste)
* [P.10: Prefer immutable data to mutable data](S-03-Philosophy.md#Rp-mutable)
* [P.11: Encapsulate messy constructs, rather than spreading through the code](S-03-Philosophy.md#Rp-library)
* [P.12: Use supporting tools as appropriate](S-03-Philosophy.md#Rp-tools)
* [P.13: Use support libraries as appropriate](S-03-Philosophy.md#Rp-lib)
...
This is a variant of the [subset of superset principle](S-02-Introduction.md#R0) that underlies these guidelines.
