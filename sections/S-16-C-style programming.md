...
* [CPL.1: Prefer C++ to C](S-16-C-style%20programming.md#Rcpl-C)
* [CPL.2: If you must use C, use the common subset of C and C++, and compile the C code as C++](S-16-C-style%20programming.md#Rcpl-subset)
* [CPL.3: If you must use C for interfaces, use C++ in the code using such interfaces](S-16-C-style%20programming.md#Rcpl-interface)
