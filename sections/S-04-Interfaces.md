...
* [I.1: Make interfaces explicit](S-04-Interfaces.md#Ri-explicit)
* [I.2: Avoid global variables](S-04-Interfaces.md#Ri-global)
* [I.3: Avoid singletons](S-04-Interfaces.md#Ri-singleton)
* [I.4: Make interfaces precisely and strongly typed](S-04-Interfaces.md#Ri-typed)
* [I.5: State preconditions (if any)](S-04-Interfaces.md#Ri-pre)
* [I.6: Prefer `Expects()` for expressing preconditions](S-04-Interfaces.md#Ri-expects)
* [I.7: State postconditions](S-04-Interfaces.md#Ri-post)
* [I.8: Prefer `Ensures()` for expressing postconditions](S-04-Interfaces.md#Ri-ensures)
* [I.9: If an interface is a template, document its parameters using concepts](S-04-Interfaces.md#Ri-concepts)
* [I.10: Use exceptions to signal a failure to perform a required task](S-04-Interfaces.md#Ri-except)
* [I.11: Never transfer ownership by a raw pointer (`T*`)](S-04-Interfaces.md#Ri-raw)
* [I.12: Declare a pointer that must not be null as `not_null`](S-04-Interfaces.md#Ri-nullptr)
* [I.13: Do not pass an array as a single pointer](S-04-Interfaces.md#Ri-array)
* [I.22: Avoid complex initialization of global objects](S-04-Interfaces.md#Ri-global-init)
* [I.23: Keep the number of function arguments low](S-04-Interfaces.md#Ri-nargs)
* [I.24: Avoid adjacent unrelated parameters of the same type](S-04-Interfaces.md#Ri-unrelated)
* [I.25: Prefer abstract classes as interfaces to class hierarchies](S-04-Interfaces.md#Ri-abstract)
* [I.26: If you want a cross-compiler ABI, use a C-style subset](S-04-Interfaces.md#Ri-abi)
* [I.30: Encapsulate rule violations](S-04-Interfaces.md#Ri-encapsulate)
...
**References**: See the [rules for calling functions](S-05-Functions.md#SS-call).
...
* Always carefully [measure](S-11-Performance.md#Rper-measure) before making performance claims.

**See also**: [I.5](S-04-Interfaces.md#Ri-pre) and [I.7](S-04-Interfaces.md#Ri-post) for reporting precondition and postcondition violations.
