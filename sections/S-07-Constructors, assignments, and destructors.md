...
See [this in the Discussion section](S-28-Discussion.md#Sd-dtor).
...
See [discussion](S-28-Discussion.md#Sd-dtor).
To make the problem worse, many "close/release" operations are not retryable.
If at all possible, consider failure to close/cleanup a fundamental design error and terminate.
...
**See also**: [Discussion](S-28-Discussion.md#Sd-order)
...
**See also**: [Discussion](S-28-Discussion.md#Sd-factory)
...
Function objects should be cheap to copy (and therefore [passed by value](S-05-Functions.md#Rf-in)).
...
A pure interface class is simply a set of pure virtual functions; see [I.25](S-04-Interfaces.md#Ri-abstract).
...
* This rule is part of the [type-safety profile](S-22-Profiles.md#Pro-type-downcast).
