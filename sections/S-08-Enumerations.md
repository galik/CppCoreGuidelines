...
* [Enum.1: Prefer enumerations over macros](S-08-Enumerations.md#Renum-macro)
* [Enum.2: Use enumerations to represent sets of related named constants](S-08-Enumerations.md#Renum-set)
* [Enum.3: Prefer `enum class`es over "plain" `enum`s](S-08-Enumerations.md#Renum-class)
* [Enum.4: Define operations on enumerations for safe and simple use](S-08-Enumerations.md#Renum-oper)
* [Enum.5: Don't use `ALL_CAPS` for enumerators](S-08-Enumerations.md#Renum-caps)
* [Enum.6: Avoid unnamed enumerations](S-08-Enumerations.md#Renum-unnamed)
* [Enum.7: Specify the underlying type of an enumeration only when necessary](S-08-Enumerations.md#Renum-underlying)
* [Enum.8: Specify enumerator values only when necessary](S-08-Enumerations.md#Renum-value)
