...
* [E.1: Develop an error-handling strategy early in a design](10-E-Error%20handling.md#Re-design)
* [E.2: Throw an exception to signal that a function can't perform its assigned task](10-E-Error%20handling.md#Re-throw)
* [E.3: Use exceptions for error handling only](10-E-Error%20handling.md#Re-errors)
* [E.4: Design your error-handling strategy around invariants](10-E-Error%20handling.md#Re-design-invariants)
* [E.5: Let a constructor establish an invariant, and throw if it cannot](10-E-Error%20handling.md#Re-invariant)
* [E.6: Use RAII to prevent leaks](10-E-Error%20handling.md#Re-raii)
* [E.7: State your preconditions](10-E-Error%20handling.md#Re-precondition)
* [E.8: State your postconditions](10-E-Error%20handling.md#Re-postcondition)

* [E.12: Use `noexcept` when exiting a function because of a `throw` is impossible or unacceptable](10-E-Error%20handling.md#Re-noexcept)
* [E.13: Never throw while being the direct owner of an object](10-E-Error%20handling.md#Re-never-throw)
* [E.14: Use purpose-designed user-defined types as exceptions (not built-in types)](10-E-Error%20handling.md#Re-exception-types)
* [E.15: Catch exceptions from a hierarchy by reference](10-E-Error%20handling.md#Re-exception-ref)
* [E.16: Destructors, deallocation, and `swap` must never fail](10-E-Error%20handling.md#Re-never-fail)
* [E.17: Don't try to catch every exception in every function](10-E-Error%20handling.md#Re-not-always)
* [E.18: Minimize the use of explicit `try`/`catch`](10-E-Error%20handling.md#Re-catch)
* [E.19: Use a `final_action` object to express cleanup if no suitable resource handle is available](10-E-Error%20handling.md#Re-finally)

* [E.25: If you can't throw exceptions, simulate RAII for resource management](10-E-Error%20handling.md#Re-no-throw-raii)
* [E.26: If you can't throw exceptions, consider failing fast](10-E-Error%20handling.md#Re-no-throw-crash)
* [E.27: If you can't throw exceptions, use error codes systematically](10-E-Error%20handling.md#Re-no-throw-codes)
* [E.28: Avoid error handling based on global state (e.g. `errno`)](10-E-Error%20handling.md#Re-no-throw)

* [E.30: Don't use exception specifications](10-E-Error%20handling.md#Re-specifications)
* [E.31: Properly order your `catch`-clauses](10-E-Error%20handling.md#Re_catch)
...
**See also**: [discussion](25-Appendix%20C-Discussion.md#Sd-noexcept)

##### Note

Before deciding that you cannot afford or don't like exception-based error handling, have a look at the [alternatives](10-E-Error%20handling.md#Re-no-throw-raii);
...
as a last resort, cleanup actions can be represented by a [`final_action`](10-E-Error%20handling.md#Re-finally) object.
...
Do not use traditional [exception-specifications](10-E-Error%20handling.md#Re-specifications).

##### See also

[discussion](25-Appendix%20C-Discussion.md#Sd-noexcept).
...
Sometimes, [`finally()`](10-E-Error%20handling.md#Re-finally) can make such unsystematic cleanup a bit more manageable.
...
**See also**: [discussion](25-Appendix%20C-Discussion.md#Sd-never-fail)
...
Let cleanup actions on the unwinding path be handled by [RAII](10-E-Error%20handling.md#Re-raii).
...
* [`finally`](10-E-Error%20handling.md#Re-finally)
...
Prefer [proper resource management objects](10-E-Error%20handling.md#Re-raii).
Consider `finally` a last resort.

##### Note

Use of `finally` is a systematic and reasonably clean alternative to the old [`goto exit;` technique](10-E-Error%20handling.md#Re-no-throw-codes)
...
Even without exceptions, [RAII](10-E-Error%20handling.md#Re-raii) is usually the best and most systematic way of dealing with resources.
...
So, the primary guideline for error handling is "use exceptions and [RAII](10-E-Error%20handling.md#Re-raii)."
...
Before condemning exceptions or complaining too much about their cost, consider examples of the use of [error codes](10-E-Error%20handling.md#Re-no-throw-codes).
...
If no exception may be thrown, use [`noexcept`](10-E-Error%20handling.md#Re-noexcept) or its equivalent `throw()`.
