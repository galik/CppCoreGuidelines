...
* [Per.1: Don't optimize without reason](S-11-Performance.md#Rper-reason)
* [Per.2: Don't optimize prematurely](S-11-Performance.md#Rper-Knuth)
* [Per.3: Don't optimize something that's not performance critical](S-11-Performance.md#Rper-critical)
* [Per.4: Don't assume that complicated code is necessarily faster than simple code](S-11-Performance.md#Rper-simple)
* [Per.5: Don't assume that low-level code is necessarily faster than high-level code](S-11-Performance.md#Rper-low)
* [Per.6: Don't make claims about performance without measurements](S-11-Performance.md#Rper-measure)
* [Per.7: Design to enable optimization](S-11-Performance.md#Rper-efficiency)
* [Per.10: Rely on the static type system](S-11-Performance.md#Rper-type)
* [Per.11: Move computation from run time to compile time](S-11-Performance.md#Rper-Comp)
* [Per.12: Eliminate redundant aliases](S-11-Performance.md#Rper-alias)
* [Per.13: Eliminate redundant indirections](S-11-Performance.md#Rper-indirect)
* [Per.14: Minimize the number of allocations and deallocations](S-11-Performance.md#Rper-alloc)
* [Per.15: Do not allocate on a critical branch](S-11-Performance.md#Rper-alloc0)
* [Per.16: Use compact data structures](S-11-Performance.md#Rper-compact)
* [Per.17: Declare the most used member of a time-critical struct first](S-11-Performance.md#Rper-struct)
* [Per.18: Space is time](S-11-Performance.md#Rper-space)
* [Per.19: Access memory predictably](S-11-Performance.md#Rper-access)
* [Per.30: Avoid context switches on the critical path](S-11-Performance.md#Rper-context)
...
Premature optimization is said to be [the root of all evil](S-11-Performance.md#Rper-Knuth), but that's not a reason to despise performance.
...
* Information passing:
Prefer clean [interfaces](S-04-Interfaces.md#S-interfaces) carrying sufficient information for later improvement of implementation.
Note that information flows into and out of an implementation through the interfaces we provide.
* Compact data: By default, [use compact data](S-11-Performance.md#Rper-compact), such as `std::vector` and [access it in a systematic fashion](S-11-Performance.md#Rper-access).
...
Use [conventional ways](S-05-Functions.md#Rf-conventional) of passing information through an interface;
...
The [standard library](S-18-The%20Standard%20Library.md#S-stdlib) is a good first place to look for inspiration.
* Isolation:
...
A need for efficiency does not imply a need for [low-level code](S-11-Performance.md#Rper-low).
...
This rule does not contradict the [Don't optimize prematurely](S-11-Performance.md#Rper-Knuth) rule.
