...
* [C.1: Organize related data into structures (`struct`s or `class`es)](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-org)
* [C.2: Use `class` if the class has an invariant; use `struct` if the data members can vary independently](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-struct)
* [C.3: Represent the distinction between an interface and an implementation using a class](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-interface)
* [C.4: Make a function a member only if it needs direct access to the representation of a class](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-member)
* [C.5: Place helper functions in the same namespace as the class they support](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-helper)
* [C.7: Don't define a class or enum and declare a variable of its type in the same statement](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-standalone)
* [C.8: Use `class` rather than `struct` if any member is non-public](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-class)
* [C.9: Minimize exposure of members](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-private)

Subsections:

* [C.concrete: Concrete types](04-C-Classes+and+Class+Hierarchies%2Emd#SS-concrete)
* [C.ctor: Constructors, assignments, and destructors](04-C-Classes+and+Class+Hierarchies%2Emd#S-ctor)
* [C.con: Containers and other resource handles](04-C-Classes+and+Class+Hierarchies%2Emd#SS-containers)
* [C.lambdas: Function objects and lambdas](04-C-Classes+and+Class+Hierarchies%2Emd#SS-lambdas)
* [C.hier: Class hierarchies (OOP)](04-C-Classes+and+Class+Hierarchies%2Emd#SS-hier)
* [C.over: Overloading and overloaded operators](04-C-Classes+and+Class+Hierarchies%2Emd#SS-overload)
* [C.union: Unions](04-C-Classes+and+Class+Hierarchies%2Emd#SS-union)
...
* See also [define a class with private data as `class`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-class).
* See also [Prefer to place the interface first in a class](21-NL-Naming+and+layout+rules%2Emd#Rl-order).
* See also [minimize exposure of members](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-private).
* See also [Avoid `protected` data](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-protected).
...
This is especially important for [overloaded operators](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-namespace).
...
Prefer to place the interface first in a class [see](21-NL-Naming+and+layout+rules%2Emd#Rl-order).
...
[`protected` data is a bad idea](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-protected).

##### Note

Prefer the order `public` members before `protected` members before `private` members [see](21-NL-Naming+and+layout+rules%2Emd#Rl-order).

##### Enforcement

* [Flag protected data](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-protected).
...
* [C.10: Prefer concrete types over class hierarchies](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-concrete)
* [C.11: Make concrete types regular](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-regular)
...
* [C.20: If you can avoid defining any default operations, do](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-zero)
* [C.21: If you define or `=delete` any default operation, define or `=delete` them all](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-five)
* [C.22: Make default operations consistent](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-matched)

Destructor rules:

* [C.30: Define a destructor if a class needs an explicit action at object destruction](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor)
* [C.31: All resources acquired by a class must be released by the class's destructor](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-release)
* [C.32: If a class has a raw pointer (`T*`) or reference (`T&`), consider whether it might be owning](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-ptr)
* [C.33: If a class has an owning pointer member, define or `=delete` a destructor](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-ptr2)
* [C.34: If a class has an owning reference member, define or `=delete` a destructor](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-ref)
* [C.35: A base class with a virtual function needs a virtual destructor](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-virtual)
* [C.36: A destructor may not fail](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-fail)
* [C.37: Make destructors `noexcept`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-noexcept)

Constructor rules:

* [C.40: Define a constructor if a class has an invariant](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-ctor)
* [C.41: A constructor should create a fully initialized object](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-complete)
* [C.42: If a constructor cannot construct a valid object, throw an exception](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-throw)
* [C.43: Ensure that a class has a default constructor](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-default0)
* [C.44: Prefer default constructors to be simple and non-throwing](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-default00)
* [C.45: Don't define a default constructor that only initializes data members; use member initializers instead](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-default)
* [C.46: By default, declare single-argument constructors `explicit`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-explicit)
* [C.47: Define and initialize member variables in the order of member declaration](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-order)
* [C.48: Prefer in-class initializers to member initializers in constructors for constant initializers](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-in-class-initializer)
* [C.49: Prefer initialization to assignment in constructors](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-initialize)
* [C.50: Use a factory function if you need "virtual behavior" during initialization](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-factory)
* [C.51: Use delegating constructors to represent common actions for all constructors of a class](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-delegating)
* [C.52: Use inheriting constructors to import constructors into a derived class that does not need further explicit initialization](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-inheriting)

Copy and move rules:

* [C.60: Make copy assignment non-`virtual`, take the parameter by `const&`, and return by non-`const&`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-assignment)
* [C.61: A copy operation should copy](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-semantic)
* [C.62: Make copy assignment safe for self-assignment](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-self)
* [C.63: Make move assignment non-`virtual`, take the parameter by `&&`, and return by non-`const&`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-move-assignment)
* [C.64: A move operation should move and leave its source in a valid state](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-move-semantic)
* [C.65: Make move assignment safe for self-assignment](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-move-self)
* [C.66: Make move operations `noexcept`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-move-noexcept)
* [C.67: A base class should suppress copying, and provide a virtual `clone` instead if "copying" is desired](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-virtual)

Other default operations rules:

* [C.80: Use `=default` if you have to be explicit about using the default semantics](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-eqdefault)
* [C.81: Use `=delete` when you want to disable default behavior (without wanting an alternative)](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-delete)
* [C.82: Don't call virtual functions in constructors and destructors](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-ctor-virtual)
* [C.83: For value-like types, consider providing a `noexcept` swap function](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-swap)
* [C.84: A `swap` may not fail](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-swap-fail)
* [C.85: Make `swap` `noexcept`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-swap-noexcept)
* [C.86: Make `==` symmetric with respect of operand types and `noexcept`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-eq)
* [C.87: Beware of `==` on base classes](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-eq-base)
* [C.89: Make a `hash` `noexcept`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-hash)
...
For most classes the answer is "no" either because the class holds no resources or because destruction is handled by [the rule of zero](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-zero);
that is, its members can take care of themselves as concerns destruction.
If the answer is "yes", much of the design of the class follows (see [the rule of five](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-five)).
...
What about a sockets that won't close? A destructor, close, or cleanup operation [should never fail](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-fail).
...
See [discussion](25-Appendix+C-Discussion%2Emd#Sd-never-fail).
...
[A `T*` should not do so](06-R-Resource+management%2Emd#Rr-ptr), but in older code, that's common.
...
Note that if you define a destructor, you must define or delete [all default operations](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-five):
...
See [pointer members and destructors](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-ptr).
...
The problem of whether `Handle` is responsible for the destruction of its `Shape` is the same as for [the pointer case](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-ptr):
...
Unless `Shape` has its [copy assignment `=deleted`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-virtual), only the `Shape` part of `Triangle` is copied into the `Circle`.
...
See [this in the Discussion section](25-Appendix+C-Discussion%2Emd#Sd-dtor).
...
See [discussion](25-Appendix+C-Discussion%2Emd#Sd-dtor).
To make the problem worse, many "close/release" operations are not retryable.
If at all possible, consider failure to close/cleanup a fundamental design error and terminate.
...
##### Reason
 ...
 [A destructor may not fail](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-fail). If a destructor tries to exit with an exception, it's a bad design error and the program had better terminate.
...
Also, the default for `int` would be better done as a [member initializer](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-in-class-initializer).

**See also**: [construct valid object](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-complete) and [constructor throws](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-throw).
...
If a valid object cannot conveniently be constructed by a constructor, [use a factory function](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-factory).
...
If a constructor acquires a resource (to create a valid object), that resource should be [released by the destructor](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-dtor-release).
The idiom of having constructors acquire resources and destructors release them is called [RAII](06-R-Resource+management%2Emd#Rr-raii) ("Resource Acquisition Is Initialization").
...
There the `is_valid()` technique must be used. In such cases, check `is_valid()` consistently and immediately to simulate [RAII](06-R-Resource+management%2Emd#Rr-raii).
...
If you really have to, look at [factory functions](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-factory).
...
[Delegating constructors](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-delegating) and [default member initialization](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-in-class-initializer) do that better.
Another reason is been to delay initialization until an object is needed; the solution to that is often [not to declare a variable until it can be properly initialized](07-ES-Expressions+and+Statements%2Emd#Res-init)
...
**See also**: [Discussion of implicit conversions](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-conversion).
...
**See also**: [Discussion](25-Appendix+C-Discussion%2Emd#Sd-order)
...
**See also**: [Discussion](25-Appendix+C-Discussion%2Emd#Sd-factory)
...
**See also**: If the "repeated action" is a simple initialization, consider [an in-class member initializer](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-in-class-initializer).
...
By writing directly to the target elements, we will get only [the basic guarantee](#???) rather than the strong guarantee offered by the `swap` technique. Beware of [self assignment](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-self).
...
See [copy constructor vs. `clone()`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-virtual).
...
You can handle self-assignment by explicitly testing for self-assignment, but often it is faster and more elegant to cope without such a test (e.g., [using `swap`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-swap)).
...
**See**: [The rule for copy-assignment](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-assignment).

##### Enforcement

Equivalent to what is done for [copy-assignment](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-assignment).
...
The one-in-a-million argument against `if (this == &a) return *this;` tests from the discussion of [self-assignment](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-self) is even more relevant for self-move.
...
If you need covariant return types, return an `owner<derived*>`. See [C.130](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-copy).
...
**See also** [factory functions](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-factory) for how to achieve the effect of a call to a derived class function without risking undefined behavior.
...
##### Reason
 ...
 [A `swap` may not fail](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-swap-fail).
...
**See also**: [Resources](06-R-Resource+management%2Emd#S-resource)
...
Function objects should be cheap to copy (and therefore [passed by value](03-F-Functions%2Emd#Rf-in)).

Summary:

* [F.50: Use a lambda when a function won't do (to capture local variables, or to write a local function)](03-F-Functions%2Emd#Rf-capture-vs-overload)
* [F.52: Prefer capturing by reference in lambdas that will be used locally, including passed to algorithms](03-F-Functions%2Emd#Rf-reference-capture)
* [F.53: Avoid capturing by reference in lambdas that will be used nonlocally, including returned, stored on the heap, or passed to another thread](03-F-Functions%2Emd#Rf-value-capture)
* [ES.28: Use lambdas for complex initialization, especially of `const` variables](07-ES-Expressions+and+Statements%2Emd#Res-lambda-init)
...
* [C.120: Use class hierarchies to represent concepts with inherent hierarchical structure (only)](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-domain)
* [C.121: If a base class is used as an interface, make it a pure abstract class](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-abstract)
* [C.122: Use abstract classes as interfaces when complete separation of interface and implementation is needed](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-separation)

Designing rules for classes in a hierarchy summary:

* [C.126: An abstract class typically doesn't need a constructor](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-abstract-ctor)
* [C.127: A class with a virtual function should have a virtual or protected destructor](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-dtor)
* [C.128: Virtual functions should specify exactly one of `virtual`, `override`, or `final`](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-override)
* [C.129: When designing a class hierarchy, distinguish between implementation inheritance and interface inheritance](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-kind)
* [C.130: Redefine or prohibit copying for a base class; prefer a virtual `clone` function instead](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-copy)
* [C.131: Avoid trivial getters and setters](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-get)
* [C.132: Don't make a function `virtual` without reason](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-virtual)
* [C.133: Avoid `protected` data](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-protected)
* [C.134: Ensure all non-`const` data members have the same access level](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-public)
* [C.135: Use multiple inheritance to represent multiple distinct interfaces](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-mi-interface)
* [C.136: Use multiple inheritance to represent the union of implementation attributes](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-mi-implementation)
* [C.137: Use `virtual` bases to avoid overly general base classes](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-vbase)
* [C.138: Create an overload set for a derived class and its bases with `using`](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-using)
* [C.139: Use `final` sparingly](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-final)
* [C.140: Do not provide different default arguments for a virtual function and an overrider](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-virtual-default-arg)

Accessing objects in a hierarchy rule summary:

* [C.145: Access polymorphic objects through pointers and references](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-poly)
* [C.146: Use `dynamic_cast` where class hierarchy navigation is unavoidable](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-dynamic_cast)
* [C.147: Use `dynamic_cast` to a reference type when failure to find the required class is considered an error](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-ref-cast)
* [C.148: Use `dynamic_cast` to a pointer type when failure to find the required class is considered a valid alternative](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-ptr-cast)
* [C.149: Use `unique_ptr` or `shared_ptr` to avoid forgetting to `delete` objects created using `new`](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-smart)
* [C.150: Use `make_unique()` to construct objects owned by `unique_ptr`s](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-make_unique)
* [C.151: Use `make_shared()` to construct objects owned by `shared_ptr`s](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-make_shared)
* [C.152: Never assign a pointer to an array of derived class objects to a pointer to its base](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-array)
...
A pure interface class is simply a set of pure virtual functions; see [I.25](02-I-Interfaces%2Emd#Ri-abstract).
...
Note that because of language rules, the covariant return type cannot be a smart pointer. See also [C.67](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-virtual).
...
Note that we can put default initializers on member variables: [C.49: Prefer initialization to assignment in constructors](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-initialize).
...
[Prefer `private` data](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-private) with a well-specified and enforced invariant.
Alternative, and often better, [keep data out of any class used as an interface](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-abstract).
...
* *All public*: If you're writing an aggregate bundle-of-variables without an invariant across those variables, then all the variables should be `public`.
  [By convention, declare such classes `struct` rather than `class`](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-struct)
...
`Interface` is the root of an [interface hierarchy](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-abstract)
...
Contrast with [C.147](04-C-Classes+and+Class+Hierarchies%2Emd#Rh-ptr-cast), where failure is an error, and should not be used for conditional execution.
...
* [C.160: Define operators primarily to mimic conventional usage](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-conventional)
* [C.161: Use nonmember functions for symmetric operators](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-symmetric)
* [C.162: Overload operations that are roughly equivalent](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-equivalent)
* [C.163: Overload only for operations that are roughly equivalent](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-equivalent-2)
* [C.164: Avoid conversion operators](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-conversion)
* [C.165: Use `using` for customization points](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-custom)
* [C.166: Overload unary `&` only as part of a system of smart pointers and references](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-address-of)
* [C.167: Use an operator for an operation with its conventional meaning](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-overload)
* [C.168: Define overloaded operators in the namespace of their operands](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-namespace)
* [C.170: If you feel like overloading a lambda, use a generic lambda](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-lambda)
...
Here, the conventional semantics is maintained: [Copies compare equal](04-C-Classes+and+Class+Hierarchies%2Emd#SS-copy).
...
Non-member operators should be either friends or defined in [the same namespace as their operands](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-namespace).
[Binary operators should treat their operands equivalently](04-C-Classes+and+Class+Hierarchies%2Emd#Ro-symmetric).
...
This is a special case of the rule that [helper functions should be defined in the same namespace as their class](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-helper).
...
* [C.180: Use `union`s to save Memory](04-C-Classes+and+Class+Hierarchies%2Emd#Ru-union)
* [C.181: Avoid "naked" `union`s](04-C-Classes+and+Class+Hierarchies%2Emd#Ru-naked)
* [C.182: Use anonymous `union`s to implement tagged unions](04-C-Classes+and+Class+Hierarchies%2Emd#Ru-anonymous)
* [C.183: Don't use a `union` for type punning](04-C-Classes+and+Class+Hierarchies%2Emd#Ru-pun)
* ???
...
But heed the warning: [Avoid "naked" `union`s](04-C-Classes+and+Class+Hierarchies%2Emd#Ru-naked)
