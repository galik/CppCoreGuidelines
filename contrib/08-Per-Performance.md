...
* [Per.1: Don't optimize without reason](08%2dPer%2dPerformance%2emd#Rper-reason)
* [Per.2: Don't optimize prematurely](08%2dPer%2dPerformance%2emd#Rper-Knuth)
* [Per.3: Don't optimize something that's not performance critical](08%2dPer%2dPerformance%2emd#Rper-critical)
* [Per.4: Don't assume that complicated code is necessarily faster than simple code](08%2dPer%2dPerformance%2emd#Rper-simple)
* [Per.5: Don't assume that low-level code is necessarily faster than high-level code](08%2dPer%2dPerformance%2emd#Rper-low)
* [Per.6: Don't make claims about performance without measurements](08%2dPer%2dPerformance%2emd#Rper-measure)
* [Per.7: Design to enable optimization](08%2dPer%2dPerformance%2emd#Rper-efficiency)
* [Per.10: Rely on the static type system](08%2dPer%2dPerformance%2emd#Rper-type)
* [Per.11: Move computation from run time to compile time](08%2dPer%2dPerformance%2emd#Rper-Comp)
* [Per.12: Eliminate redundant aliases](08%2dPer%2dPerformance%2emd#Rper-alias)
* [Per.13: Eliminate redundant indirections](08%2dPer%2dPerformance%2emd#Rper-indirect)
* [Per.14: Minimize the number of allocations and deallocations](08%2dPer%2dPerformance%2emd#Rper-alloc)
* [Per.15: Do not allocate on a critical branch](08%2dPer%2dPerformance%2emd08%2dPer%2dPerformance%2emd#Rper-alloc0)
* [Per.16: Use compact data structures](08%2dPer%2dPerformance%2emd#Rper-compact)
* [Per.17: Declare the most used member of a time-critical struct first](08%2dPer%2dPerformance%2emd#Rper-struct)
* [Per.18: Space is time](08%2dPer%2dPerformance%2emd#Rper-space)
* [Per.19: Access memory predictably](08%2dPer%2dPerformance%2emd#Rper-access)
* [Per.30: Avoid context switches on the critical path](08%2dPer%2dPerformance%2emd#Rper-context)
...
Premature optimization is said to be [the root of all evil](08%2dPer%2dPerformance%2emd#Rper-Knuth), but that's not a reason to despise performance.
...
* Information passing:
Prefer clean [interfaces](02%2dI%2dInterfaces%2emd#S-interfaces) carrying sufficient information for later improvement of implementation.
Note that information flows into and out of an implementation through the interfaces we provide.
* Compact data: By default, [use compact data](08%2dPer%2dPerformance%2emd#Rper-compact), such as `std::vector` and [access it in a systematic fashion](08%2dPer%2dPerformance%2emd#Rper-access).
...
Use [conventional ways](03%2dF%2dFunctions%2emd#Rf-conventional) of passing information through an interface;
...
The [standard library](15%2dSL%2dThe%20Standard%20Library%2emd#S-stdlib) is a good first place to look for inspiration.
* Isolation:
...
A need for efficiency does not imply a need for [low-level code](08%2dPer%2dPerformance%2emd#Rper-low).
...
This rule does not contradict the [Don't optimize prematurely](08%2dPer%2dPerformance%2emd#Rper-Knuth) rule.
