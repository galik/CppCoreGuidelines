...
* [Per.15: Do not allocate on a critical branch](./08-Per-Performance.md./08-Per-Performance.md#Rper-alloc0)
...
time is spent on A or B, see <a href="./08-Per-Performance.md#Rper-reason">Per.1</a> and <a
href="./08-Per-Performance.md#Rper-Knuth">Per.2</a>.)
...
The [standard library](./15-SL-The Standard Library.md#S-stdlib) is a good first place to look for inspiration.
* Isolation:
