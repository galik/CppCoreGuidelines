...
* [CP.1: Assume that your code will run as part of a multi-threaded program](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-multi)
* [CP.2: Avoid data races](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-races)
* [CP.3: Minimize explicit sharing of writable data](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-data)
* [CP.4: Think in terms of tasks, rather than threads](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-task)
* [CP.8: Don't try to use `volatile` for synchronization](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-volatile)
* [CP.9: Whenever feasible use tools to validate your concurrent code](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-tools)

See also:

* [CP.con: Concurrency](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-con)
* [CP.par: Parallelism](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-par)
* [CP.mess: Message passing](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-mess)
* [CP.vec: Vectorization](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-vec)
* [CP.free: Lock-free programming](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-free)
* [CP.etc: Etc. concurrency rules](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-etc)
...
[(rare) proper uses of `volatile`](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-volatile2)
...
* For parallel algorithms, see [parallelism](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-par)
* For inter-task communication without explicit sharing, see [messaging](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-mess)
* For vector parallel code, see [vectorization](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-vec)
* For lock-free programming, see [lock free](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#SScp-free)

Concurrency rule summary:

* [CP.20: Use RAII, never plain `lock()`/`unlock()`](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-raii)
* [CP.21: Use `std::lock()` or `std::scoped_lock` to acquire multiple `mutex`es](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-lock)
* [CP.22: Never call unknown code while holding a lock (e.g., a callback)](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-unknown)
* [CP.23: Think of a joining `thread` as a scoped container](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-join)
* [CP.24: Think of a detached `thread` as a global container](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-detach)
* [CP.25: Prefer `gsl::raii_thread` over `std::thread` unless you plan to `detach()`](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-raii_thread)
* [CP.26: Prefer `gsl::detached_thread` over `std::thread` if you plan to `detach()`](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-detached_thread)
* [CP.27: Use plain `std::thread` for `thread`s that detach based on a run-time condition (only)](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-thread)
* [CP.28: Remember to join scoped `thread`s that are not `detach()`ed](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-join-undetached)
* [CP.30: Do not pass pointers to local variables to non-`raii_thread`s](#Rconc-pass)
* [CP.31: Pass small amounts of data between threads by value, rather than by reference or pointer](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-data-by-value)
* [CP.32: To share ownership between unrelated `thread`s use `shared_ptr`](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-shared)
* [CP.40: Minimize context switching](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-switch)
* [CP.41: Minimize thread creation and destruction](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-create)
* [CP.42: Don't `wait` without a condition](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-wait)
* [CP.43: Minimize time spent in a critical section](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-time)
* [CP.44: Remember to name your `lock_guard`s and `unique_lock`s](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-name)
* [CP.50: Define a `mutex` together with the data it protects](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-mutex)
...
But that compromises safety and violates the [use RAII](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-raii) rule.
...
* [CP.60: Use a `future` to return a value from a concurrent task](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-future)
* [CP.61: Use a `async()` to spawn a concurrent task](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-async)
* message queues
* messaging libraries
...
* [CP.100: Don't use lock-free programming unless you absolutely have to](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-lockfree)
* [CP.101: Distrust your hardware/compiler combination](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-distrust)
* [CP.102: Carefully study the literature](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-literature)
* how/when to use atomics
* avoid starvation
* use a lock free data structure rather than hand-crafting specific lock-free access
* [CP.110: Do not write your own double-checked locking for initialization](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-double)
* [CP.111: Use a conventional pattern if you really need double-checked locking](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-double-pattern)
...
Double-checked locking is easy to mess up. If you really need to write your own double-checked locking, in spite of the rules [CP.110: Do not write your own double-checked locking for initialization](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-double) and [CP.100: Don't use lock-free programming unless you absolutely have to](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-lockfree), then do it in a conventional pattern.

The uses of the double-checked locking pattern that are not in violation of [CP.110: Do not write your own double-checked locking for initialization](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-double) arise when a non-thread-safe action is both hard and rare, and there exists a fast thread-safe test that can be used to guarantee that the action is not needed, but cannot be used to guarantee the converse.

##### Example, bad

The use of volatile does not make the first check thread-safe, see also [CP.200: Use `volatile` only to talk to non-C++ memory](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-volatile2)
...
* [CP.200: Use `volatile` only to talk to non-C++ memory](09%2dCP%2dConcurrency%20and%20Parallelism%2emd09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-volatile2)
* [CP.201: ??? Signals](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-signal)
...
In C++, unlike in some other languages, `volatile` has [nothing to do with synchronization](09%2dCP%2dConcurrency%20and%20Parallelism%2emd#Rconc-volatile).
