...
* Resource management rule summary:
  ...
  * [R.1: Manage resources automatically using resource handles and RAII (Resource Acquisition Is Initialization)](06%2dR%2dResource%20management%2emd#Rr-raii)
  * [R.2: In interfaces, use raw pointers to denote individual objects (only)](06%2dR%2dResource%20management%2emd#Rr-use-ptr)
  * [R.3: A raw pointer (a `T*`) is non-owning](06%2dR%2dResource%20management%2emd#Rr-ptr)
  * [R.4: A raw reference (a `T&`) is non-owning](06%2dR%2dResource%20management%2emd#Rr-ref)
  * [R.5: Prefer scoped objects, don't heap-allocate unnecessarily](06%2dR%2dResource%20management%2emd#Rr-scoped)
  * [R.6: Avoid non-`const` global variables](06%2dR%2dResource%20management%2emd#Rr-global)

* Allocation and deallocation rule summary:

  * [R.10: Avoid `malloc()` and `free()`](06%2dR%2dResource%20management%2emd#Rr-mallocfree)
  * [R.11: Avoid calling `new` and `delete` explicitly](06%2dR%2dResource%20management%2emd#Rr-newdelete)
  * [R.12: Immediately give the result of an explicit resource allocation to a manager object](06%2dR%2dResource%20management%2emd#Rr-immediate-alloc)
  * [R.13: Perform at most one explicit resource allocation in a single expression statement](06%2dR%2dResource%20management%2emd#Rr-single-alloc)
  * [R.14: ??? array vs. pointer parameter](06%2dR%2dResource%20management%2emd#Rr-ap)
  * [R.15: Always overload matched allocation/deallocation pairs](06%2dR%2dResource%20management%2emd#Rr-pair)

* <a name="Rr-summary-smartptrs"></a>Smart pointer rule summary:

  * [R.20: Use `unique_ptr` or `shared_ptr` to represent ownership](06%2dR%2dResource%20management%2emd#Rr-owner)
  * [R.21: Prefer `unique_ptr` over `shared_ptr` unless you need to share ownership](06%2dR%2dResource%20management%2emd#Rr-unique)
  * [R.22: Use `make_shared()` to make `shared_ptr`s](06%2dR%2dResource%20management%2emd#Rr-make_shared)
  * [R.23: Use `make_unique()` to make `unique_ptr`s](06%2dR%2dResource%20management%2emd#Rr-make_unique)
  * [R.24: Use `std::weak_ptr` to break cycles of `shared_ptr`s](06%2dR%2dResource%20management%2emd#Rr-weak_ptr)
  * [R.30: Take smart pointers as parameters only to explicitly express lifetime semantics](06%2dR%2dResource%20management%2emd06%2dR%2dResource%20management%2emd#Rr-smartptrparam)
  * [R.31: If you have non-`std` smart pointers, follow the basic pattern from `std`](06%2dR%2dResource%20management%2emd#Rr-smart)
  * [R.32: Take a `unique_ptr<widget>` parameter to express that a function assumes ownership of a `widget`](06%2dR%2dResource%20management%2emd06%2dR%2dResource%20management%2emd#Rr-uniqueptrparam)
  * [R.33: Take a `unique_ptr<widget>&` parameter to express that a function reseats the `widget`](06%2dR%2dResource%20management%2emd#Rr-reseat)
  * [R.34: Take a `shared_ptr<widget>` parameter to express that a function is part owner](06%2dR%2dResource%20management%2emd06%2dR%2dResource%20management%2emd#Rr-sharedptrparam-owner)
  * [R.35: Take a `shared_ptr<widget>&` parameter to express that a function might reseat the shared pointer](06%2dR%2dResource%20management%2emd#Rr-sharedptrparam)
  * [R.36: Take a `const shared_ptr<widget>&` parameter to express that it might retain a reference count to the object ???](06%2dR%2dResource%20management%2emd06%2dR%2dResource%20management%2emd#Rr-sharedptrparam-const)
  * [R.37: Do not pass a pointer or reference obtained from an aliased smart pointer](06%2dR%2dResource%20management%2emd06%2dR%2dResource%20management%2emd#Rr-smartptrget)
...
Where a resource is "ill-behaved" in that it isn't represented as a class with a destructor, wrap it in a class or use [`finally`](20%2dGSL%2dGuideline%20support%20library%2emd#S-gsl)

**See also**: [RAII](06%2dR%2dResource%20management%2emd#Rr-raii).
...
**See also**: [The raw pointer rule](06%2dR%2dResource%20management%2emd#Rr-ptr)

##### Enforcement

See [the raw pointer rule](06%2dR%2dResource%20management%2emd#Rr-ptr)
...
Both cases are an error under the [`sharedptrparam` guideline](06%2dR%2dResource%20management%2emd06%2dR%2dResource%20management%2emd#Rr-smartptrparam):
