...
* <a name="Rr-summary-smartptrs"></a>Smart pointer rule summary:
  ...
  * [R.30: Take smart pointers as parameters only to explicitly express lifetime semantics](06-R-Resource+management.md#Rr-smartptrparam)
  * [R.31: If you have non-`std` smart pointers, follow the basic pattern from `std`](06-R-Resource+management.md#Rr-smart)
  * [R.32: Take a `unique_ptr<widget>` parameter to express that a function assumes ownership of a `widget`](06-R-Resource+management.md#Rr-uniqueptrparam)
  ...
  * [R.34: Take a `shared_ptr<widget>` parameter to express that a function is part owner](06-R-Resource+management.md#Rr-sharedptrparam-owner)
  ...
  * [R.36: Take a `const shared_ptr<widget>&` parameter to express that it might retain a reference count to the object ???](06-R-Resource+management.md#Rr-sharedptrparam-const)
  * [R.37: Do not pass a pointer or reference obtained from an aliased smart pointer](06-R-Resource+management.md#Rr-smartptrget)
...
Both cases are an error under the [`sharedptrparam` guideline](06-R-Resource+management.md#Rr-smartptrparam):
