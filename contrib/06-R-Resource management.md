...
* Resource management rule summary:
  ...
  * [R.1: Manage resources automatically using resource handles and RAII (Resource Acquisition Is Initialization)](./06-R-Resource management.md#Rr-raii)
  * [R.2: In interfaces, use raw pointers to denote individual objects (only)](./06-R-Resource management.md#Rr-use-ptr)
  * [R.3: A raw pointer (a `T*`) is non-owning](./06-R-Resource management.md#Rr-ptr)
  * [R.4: A raw reference (a `T&`) is non-owning](./06-R-Resource management.md#Rr-ref)
  * [R.5: Prefer scoped objects, don't heap-allocate unnecessarily](./06-R-Resource management.md#Rr-scoped)
  * [R.6: Avoid non-`const` global variables](./06-R-Resource management.md#Rr-global)

* Allocation and deallocation rule summary:

  * [R.10: Avoid `malloc()` and `free()`](./06-R-Resource management.md#Rr-mallocfree)
  * [R.11: Avoid calling `new` and `delete` explicitly](./06-R-Resource management.md#Rr-newdelete)
  * [R.12: Immediately give the result of an explicit resource allocation to a manager object](./06-R-Resource management.md#Rr-immediate-alloc)
  * [R.13: Perform at most one explicit resource allocation in a single expression statement](./06-R-Resource management.md#Rr-single-alloc)
  * [R.14: ??? array vs. pointer parameter](./06-R-Resource management.md#Rr-ap)
  * [R.15: Always overload matched allocation/deallocation pairs](./06-R-Resource management.md#Rr-pair)

* <a name="Rr-summary-smartptrs"></a>Smart pointer rule summary:

  * [R.20: Use `unique_ptr` or `shared_ptr` to represent ownership](./06-R-Resource management.md#Rr-owner)
  * [R.21: Prefer `unique_ptr` over `shared_ptr` unless you need to share ownership](./06-R-Resource management.md#Rr-unique)
  * [R.22: Use `make_shared()` to make `shared_ptr`s](./06-R-Resource management.md#Rr-make_shared)
  * [R.23: Use `make_unique()` to make `unique_ptr`s](./06-R-Resource management.md#Rr-make_unique)
  * [R.24: Use `std::weak_ptr` to break cycles of `shared_ptr`s](./06-R-Resource management.md#Rr-weak_ptr)
  * [R.30: Take smart pointers as parameters only to explicitly express lifetime semantics](./06-R-Resource management.md./06-R-Resource management.md#Rr-smartptrparam)
  * [R.31: If you have non-`std` smart pointers, follow the basic pattern from `std`](./06-R-Resource management.md#Rr-smart)
  * [R.32: Take a `unique_ptr<widget>` parameter to express that a function assumes ownership of a `widget`](./06-R-Resource management.md./06-R-Resource management.md#Rr-uniqueptrparam)
  * [R.33: Take a `unique_ptr<widget>&` parameter to express that a function reseats the `widget`](./06-R-Resource management.md#Rr-reseat)
  * [R.34: Take a `shared_ptr<widget>` parameter to express that a function is part owner](./06-R-Resource management.md./06-R-Resource management.md#Rr-sharedptrparam-owner)
  * [R.35: Take a `shared_ptr<widget>&` parameter to express that a function might reseat the shared pointer](./06-R-Resource management.md#Rr-sharedptrparam)
  * [R.36: Take a `const shared_ptr<widget>&` parameter to express that it might retain a reference count to the object ???](./06-R-Resource management.md./06-R-Resource management.md#Rr-sharedptrparam-const)
  * [R.37: Do not pass a pointer or reference obtained from an aliased smart pointer](./06-R-Resource management.md./06-R-Resource management.md#Rr-smartptrget)
...
Where a resource is "ill-behaved" in that it isn't represented as a class with a destructor, wrap it in a class or use [`finally`](./20-GSL-Guideline support library.md#S-gsl)

**See also**: [RAII](./06-R-Resource management.md#Rr-raii).
...
**See also**: [The raw pointer rule](./06-R-Resource management.md#Rr-ptr)

##### Enforcement

See [the raw pointer rule](./06-R-Resource management.md#Rr-ptr)
...
Both cases are an error under the [`sharedptrparam` guideline](./06-R-Resource management.md./06-R-Resource management.md#Rr-smartptrparam):
