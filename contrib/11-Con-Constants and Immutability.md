...
* [Con.5: Use `constexpr` for values that can be computed at compile time](11-Con-Constants+and+Immutability.md#Rconst-constexpr)
...
* "cast away `const`"; [best avoided](07-ES-Expressions+and+Statements.md#Res-casts-const)
...
[Do not cast away `const`](07-ES-Expressions+and+Statements.md#Res-casts-const).
