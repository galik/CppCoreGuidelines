...
* [SF.7: Don't write `using namespace` in a header file](14-SF-Source+files.md#Rs-using-directive)
...
* [SF.22: Use an unnamed (anonymous) namespace for all internal/nonexported entities](14-SF-Source+files.md#Rs-unnamed2)
...
[Don't write `using namespace` in a header file](14-SF-Source+files.md#Rs-using-directive).
