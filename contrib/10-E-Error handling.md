...
* [E.4: Design your error-handling strategy around invariants](10-E-Error+handling.md#Re-design-invariants)
...
* [E.25: If you can't throw exceptions, simulate RAII for resource management](10-E-Error+handling.md#Re-no-throw-raii)
* [E.26: If you can't throw exceptions, consider failing fast](10-E-Error+handling.md#Re-no-throw-crash)
* [E.27: If you can't throw exceptions, use error codes systematically](10-E-Error+handling.md#Re-no-throw-codes)
...
Before deciding that you cannot afford or don't like exception-based error handling, have a look at the [alternatives](10-E-Error+handling.md#Re-no-throw-raii);
...
Before condemning exceptions or complaining too much about their cost, consider examples of the use of [error codes](10-E-Error+handling.md#Re-no-throw-codes).
...
See also [Simulating RAII](10-E-Error+handling.md#Re-no-throw-raii).
...
This approach fits with [simulated RAII resource management](10-E-Error+handling.md#Re-no-throw-raii).
