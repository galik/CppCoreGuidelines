...
* [E.1: Develop an error-handling strategy early in a design](10-E-Error+handling%2Emd#Re-design)
* [E.2: Throw an exception to signal that a function can't perform its assigned task](10-E-Error+handling%2Emd#Re-throw)
* [E.3: Use exceptions for error handling only](10-E-Error+handling%2Emd#Re-errors)
* [E.4: Design your error-handling strategy around invariants](10-E-Error+handling%2Emd#Re-design-invariants)
* [E.5: Let a constructor establish an invariant, and throw if it cannot](10-E-Error+handling%2Emd#Re-invariant)
* [E.6: Use RAII to prevent leaks](10-E-Error+handling%2Emd#Re-raii)
* [E.7: State your preconditions](10-E-Error+handling%2Emd#Re-precondition)
* [E.8: State your postconditions](10-E-Error+handling%2Emd#Re-postcondition)

* [E.12: Use `noexcept` when exiting a function because of a `throw` is impossible or unacceptable](10-E-Error+handling%2Emd#Re-noexcept)
* [E.13: Never throw while being the direct owner of an object](10-E-Error+handling%2Emd#Re-never-throw)
* [E.14: Use purpose-designed user-defined types as exceptions (not built-in types)](10-E-Error+handling%2Emd#Re-exception-types)
* [E.15: Catch exceptions from a hierarchy by reference](10-E-Error+handling%2Emd#Re-exception-ref)
* [E.16: Destructors, deallocation, and `swap` must never fail](10-E-Error+handling%2Emd#Re-never-fail)
* [E.17: Don't try to catch every exception in every function](10-E-Error+handling%2Emd#Re-not-always)
* [E.18: Minimize the use of explicit `try`/`catch`](10-E-Error+handling%2Emd#Re-catch)
* [E.19: Use a `final_action` object to express cleanup if no suitable resource handle is available](10-E-Error+handling%2Emd#Re-finally)

* [E.25: If you can't throw exceptions, simulate RAII for resource management](10-E-Error+handling%2Emd#Re-no-throw-raii)
* [E.26: If you can't throw exceptions, consider failing fast](10-E-Error+handling%2Emd#Re-no-throw-crash)
* [E.27: If you can't throw exceptions, use error codes systematically](10-E-Error+handling%2Emd#Re-no-throw-codes)
* [E.28: Avoid error handling based on global state (e.g. `errno`)](10-E-Error+handling%2Emd#Re-no-throw)

* [E.30: Don't use exception specifications](10-E-Error+handling%2Emd#Re-specifications)
* [E.31: Properly order your `catch`-clauses](10-E-Error+handling%2Emd#Re_catch)
...
* A constructor that cannot construct an object (failure to establish its class's [invariant](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-struct))
...
**See also**: [RAII](10-E-Error+handling%2Emd#Re-raii)

**See also**: [discussion](25-Appendix+C-Discussion%2Emd#Sd-noexcept)

##### Note

Before deciding that you cannot afford or don't like exception-based error handling, have a look at the [alternatives](10-E-Error+handling%2Emd#Re-no-throw-raii);
...
An [invariant](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-struct) is logical condition for the members of an object that a constructor must establish for the public member functions to assume.
...
**See also**: [If a constructor cannot construct a valid object, throw an exception](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-throw)
...
as a last resort, cleanup actions can be represented by a [`final_action`](10-E-Error+handling%2Emd#Re-finally) object.
...
**See also**: [precondition rule](02-I-Interfaces%2Emd#Ri-pre).
...
**See also**: [postcondition rule](02-I-Interfaces%2Emd#Ri-post).
...
Do not use traditional [exception-specifications](10-E-Error+handling%2Emd#Re-specifications).

##### See also

[discussion](25-Appendix+C-Discussion%2Emd#Sd-noexcept).
...
Sometimes, [`finally()`](10-E-Error+handling%2Emd#Re-finally) can make such unsystematic cleanup a bit more manageable.
...
Most handlers do not modify their exception and in general we [recommend use of `const`](07-ES-Expressions+and+Statements%2Emd#Res-const).
...
**See also**: [discussion](25-Appendix+C-Discussion%2Emd#Sd-never-fail)
...
Let cleanup actions on the unwinding path be handled by [RAII](10-E-Error+handling%2Emd#Re-raii).
...
* proper resource handles and [RAII](10-E-Error+handling%2Emd#Re-raii)
* [`finally`](10-E-Error+handling%2Emd#Re-finally)
...
Prefer [proper resource management objects](10-E-Error+handling%2Emd#Re-raii).
...
Even without exceptions, [RAII](10-E-Error+handling%2Emd#Re-raii) is usually the best and most systematic way of dealing with resources.
...
So, the primary guideline for error handling is "use exceptions and [RAII](10-E-Error+handling%2Emd#Re-raii)."
...
Before condemning exceptions or complaining too much about their cost, consider examples of the use of [error codes](10-E-Error+handling%2Emd#Re-no-throw-codes).
...
See also [Simulating RAII](10-E-Error+handling%2Emd#Re-no-throw-raii).
...
This approach fits with [simulated RAII resource management](10-E-Error+handling%2Emd#Re-no-throw-raii).
...
`finally` can [ease the pain a bit](10-E-Error+handling%2Emd#Re-finally).
...
We [prefer exception-based error handling](10-E-Error+handling%2Emd#Re-throw) and recommend [keeping functions short](03-F-Functions%2Emd#Rf-single).

**See also**: [Discussion](#Sd-???).

**See also**: [Returning multiple values](03-F-Functions%2Emd#Rf-out-multi).
...
For example, see [Stroustrup94](27-Bibliography%2Emd#Stroustrup94).

##### Note

If no exception may be thrown, use [`noexcept`](10-E-Error+handling%2Emd#Re-noexcept) or its equivalent `throw()`.
