...
* [SL.con: Containers](15-SL-The+Standard+Library%2Emd#SS-con)
* [SL.str: String](15-SL-The+Standard+Library%2Emd#SS-string)
* [SL.io: Iostream](15-SL-The+Standard+Library%2Emd#SS-io)
* [SL.regex: Regex](15-SL-The+Standard+Library%2Emd#SS-regex)
* [SL.chrono: Time](15-SL-The+Standard+Library%2Emd#SS-chrono)
* [SL.C: The C standard library](15-SL-The+Standard+Library%2Emd#SS-clib)

Standard-library rule summary:

* [SL.1: Use libraries wherever possible](15-SL-The+Standard+Library%2Emd#Rsl-lib)
* [SL.2: Prefer the standard library to other libraries](15-SL-The+Standard+Library%2Emd#Rsl-sl)
* [SL.3: Do not add non-standard entities to namespace `std`](15-SL-The+Standard+Library%2Emd#sl-std)
* ???
...
* [SL.con.1: Prefer using STL `array` or `vector` instead of a C array](15-SL-The+Standard+Library%2Emd#Rsl-arrays)
* [SL.con.2: Prefer using STL `vector` by default unless you have a reason to use a different container](15-SL-The+Standard+Library%2Emd#Rsl-vector)
*  ???
...
See also [regular expressions](15-SL-The+Standard+Library%2Emd#SS-regex).
...
* [SL.str.1: Use `std::string` to own character sequences](15-SL-The+Standard+Library%2Emd#Rstr-string)
* [SL.str.2: Use `std::string_view` or `gsl::string_span` to refer to character sequences](15-SL-The+Standard+Library%2Emd#Rstr-view)
* [SL.str.3: Use `zstring` or `czstring` to refer to a C-style, zero-terminated, sequence of characters](15-SL-The+Standard+Library%2Emd#Rstr-zstring)
* [SL.str.4: Use `char*` to refer to a single character](15-SL-The+Standard+Library%2Emd#Rstr-char*)
* [Sl.str.5: Use `std::byte` to refer to byte values that do not necessarily represent characters](15-SL-The+Standard+Library%2Emd#Rstr-byte)

* [Sl.str.10: Use `std::string` when you need to perform locale-sensitive string operations](15-SL-The+Standard+Library%2Emd#Rstr-locale)
* [Sl.str.11: Use `gsl::string_span` rather than `std::string_view` when you need to mutate a string](15-SL-The+Standard+Library%2Emd#Rstr-span)
* [Sl.str.12: Use the `s` suffix for string literals meant to be standard-library `string`s](15-SL-The+Standard+Library%2Emd#Rstr-s)

See also

* [F.24 span](03-F-Functions%2Emd#Rf-range)
* [F.25 zstring](03-F-Functions%2Emd#Rf-zstring)
...
[Don't optimize prematurely](08-Per-Performance%2Emd#Rper-Knuth)
...
See [`zstring`](15-SL-The+Standard+Library%2Emd#Rstr-zstring), [`string`](15-SL-The+Standard+Library%2Emd#Rstr-string), and [`string_span`](15-SL-The+Standard+Library%2Emd#Rstr-view).
...
`std::string` supports standard-library [`locale` facilities](15-SL-The+Standard+Library%2Emd#Rstr-locale)
...
* [SL.io.1: Use character-level input only when you have to](15-SL-The+Standard+Library%2Emd#Rio-low)
* [SL.io.2: When reading, always consider ill-formed input](15-SL-The+Standard+Library%2Emd#Rio-validate)
* [SL.io.3: Prefer iostreams for I/O](15-SL-The+Standard+Library%2Emd#Rio-streams)
* [SL.io.10: Unless you use `printf`-family functions call `ios_base::sync_with_stdio(false)`](15-SL-The+Standard+Library%2Emd#Rio-sync) 
* [SL.io.50: Avoid `endl`](15-SL-The+Standard+Library%2Emd#Rio-endl)
* [???](#???)
...
* [S.C.1: Don't use setjmp/longjmp](15-SL-The+Standard+Library%2Emd#Rclib-jmp)
* [???](#???)
* [???](#???)
