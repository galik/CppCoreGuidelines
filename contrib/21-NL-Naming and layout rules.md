...
* [NL.2: State intent in comments](21-NL-Naming+and+layout+rules.md#Rl-comments-intent)
* [NL.3: Keep comments crisp](21-NL-Naming+and+layout+rules.md#Rl-comments-crisp)
* [NL.4: Maintain a consistent indentation style](21-NL-Naming+and+layout+rules.md#Rl-indent)
* [NL.5: Don't encode type information in names](21-NL-Naming+and+layout+rules.md#Rl-name-type)
* [NL.7: Make the length of a name roughly proportional to the length of its scope](21-NL-Naming+and+layout+rules.md#Rl-name-length)
