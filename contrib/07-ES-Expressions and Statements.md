...
For naming, commenting, and indentation rules, see [NL: Naming and layout](21-NL-Naming+and+layout+rules%2Emd#S-naming).

General rules:

* [ES.1: Prefer the standard library to other libraries and to "handcrafted code"](07-ES-Expressions+and+Statements%2Emd#Res-lib)
* [ES.2: Prefer suitable abstractions to direct use of language features](07-ES-Expressions+and+Statements%2Emd#Res-abstr)

Declaration rules:

* [ES.5: Keep scopes small](07-ES-Expressions+and+Statements%2Emd#Res-scope)
* [ES.6: Declare names in for-statement initializers and conditions to limit scope](07-ES-Expressions+and+Statements%2Emd#Res-cond)
* [ES.7: Keep common and local names short, and keep uncommon and nonlocal names longer](07-ES-Expressions+and+Statements%2Emd#Res-name-length)
* [ES.8: Avoid similar-looking names](07-ES-Expressions+and+Statements%2Emd#Res-name-similar)
* [ES.9: Avoid `ALL_CAPS` names](07-ES-Expressions+and+Statements%2Emd#Res-not-CAPS)
* [ES.10: Declare one name (only) per declaration](07-ES-Expressions+and+Statements%2Emd#Res-name-one)
* [ES.11: Use `auto` to avoid redundant repetition of type names](07-ES-Expressions+and+Statements%2Emd#Res-auto)
* [ES.12: Do not reuse names in nested scopes](07-ES-Expressions+and+Statements%2Emd#Res-reuse)
* [ES.20: Always initialize an object](07-ES-Expressions+and+Statements%2Emd#Res-always)
* [ES.21: Don't introduce a variable (or constant) before you need to use it](07-ES-Expressions+and+Statements%2Emd#Res-introduce)
* [ES.22: Don't declare a variable until you have a value to initialize it with](07-ES-Expressions+and+Statements%2Emd#Res-init)
* [ES.23: Prefer the `{}`-initializer syntax](07-ES-Expressions+and+Statements%2Emd#Res-list)
* [ES.24: Use a `unique_ptr<T>` to hold pointers](07-ES-Expressions+and+Statements%2Emd#Res-unique)
* [ES.25: Declare an object `const` or `constexpr` unless you want to modify its value later on](07-ES-Expressions+and+Statements%2Emd#Res-const)
* [ES.26: Don't use a variable for two unrelated purposes](07-ES-Expressions+and+Statements%2Emd#Res-recycle)
* [ES.27: Use `std::array` or `stack_array` for arrays on the stack](07-ES-Expressions+and+Statements%2Emd#Res-stack)
...
* [ES.30: Don't use macros for program text manipulation](07-ES-Expressions+and+Statements%2Emd#Res-macros)
* [ES.31: Don't use macros for constants or "functions"](07-ES-Expressions+and+Statements%2Emd#Res-macros2)
* [ES.32: Use `ALL_CAPS` for all macro names](07-ES-Expressions+and+Statements%2Emd#Res-ALL_CAPS)
* [ES.33: If you must use macros, give them unique names](07-ES-Expressions+and+Statements%2Emd#Res-MACROS)
* [ES.34: Don't define a (C-style) variadic function](07-ES-Expressions+and+Statements%2Emd#Res-ellipses)

Expression rules:

* [ES.40: Avoid complicated expressions](07-ES-Expressions+and+Statements%2Emd#Res-complicated)
* [ES.41: If in doubt about operator precedence, parenthesize](07-ES-Expressions+and+Statements%2Emd#Res-parens)
* [ES.42: Keep use of pointers simple and straightforward](07-ES-Expressions+and+Statements%2Emd#Res-ptr)
* [ES.43: Avoid expressions with undefined order of evaluation](07-ES-Expressions+and+Statements%2Emd#Res-order)
* [ES.44: Don't depend on order of evaluation of function arguments](07-ES-Expressions+and+Statements%2Emd#Res-order-fct)
* [ES.45: Avoid "magic constants"; use symbolic constants](07-ES-Expressions+and+Statements%2Emd#Res-magic)
* [ES.46: Avoid narrowing conversions](07-ES-Expressions+and+Statements%2Emd#Res-narrowing)
* [ES.47: Use `nullptr` rather than `0` or `NULL`](07-ES-Expressions+and+Statements%2Emd#Res-nullptr)
* [ES.48: Avoid casts](07-ES-Expressions+and+Statements%2Emd#Res-casts)
* [ES.49: If you must use a cast, use a named cast](07-ES-Expressions+and+Statements%2Emd#Res-casts-named)
* [ES.50: Don't cast away `const`](07-ES-Expressions+and+Statements%2Emd#Res-casts-const)
* [ES.55: Avoid the need for range checking](07-ES-Expressions+and+Statements%2Emd#Res-range-checking)
* [ES.56: Write `std::move()` only when you need to explicitly move an object to another scope](07-ES-Expressions+and+Statements%2Emd#Res-move)
* [ES.60: Avoid `new` and `delete` outside resource management functions](07-ES-Expressions+and+Statements%2Emd#Res-new)
* [ES.61: Delete arrays using `delete[]` and non-arrays using `delete`](07-ES-Expressions+and+Statements%2Emd#Res-del)
* [ES.62: Don't compare pointers into different arrays](07-ES-Expressions+and+Statements%2Emd#Res-arr2)
* [ES.63: Don't slice](07-ES-Expressions+and+Statements%2Emd#Res-slice)

Statement rules:

* [ES.70: Prefer a `switch`-statement to an `if`-statement when there is a choice](07-ES-Expressions+and+Statements%2Emd#Res-switch-if)
* [ES.71: Prefer a range-`for`-statement to a `for`-statement when there is a choice](07-ES-Expressions+and+Statements%2Emd#Res-for-range)
* [ES.72: Prefer a `for`-statement to a `while`-statement when there is an obvious loop variable](07-ES-Expressions+and+Statements%2Emd#Res-for-while)
* [ES.73: Prefer a `while`-statement to a `for`-statement when there is no obvious loop variable](07-ES-Expressions+and+Statements%2Emd#Res-while-for)
* [ES.74: Prefer to declare a loop variable in the initializer part of a `for`-statement](07-ES-Expressions+and+Statements%2Emd#Res-for-init)
* [ES.75: Avoid `do`-statements](07-ES-Expressions+and+Statements%2Emd#Res-do)
* [ES.76: Avoid `goto`](07-ES-Expressions+and+Statements%2Emd#Res-goto)
* [ES.77: Minimize the use of `break` and `continue` in loops](07-ES-Expressions+and+Statements%2Emd#Res-continue)
* [ES.78: Always end a non-empty `case` with a `break`](07-ES-Expressions+and+Statements%2Emd#Res-break)
* [ES.79: Use `default` to handle common cases (only)](07-ES-Expressions+and+Statements%2Emd#Res-default)
* [ES.84: Don't (try to) declare a local variable with no name](07-ES-Expressions+and+Statements%2Emd#Res-noname)
* [ES.85: Make empty statements visible](07-ES-Expressions+and+Statements%2Emd#Res-empty)
* [ES.86: Avoid modifying loop control variables inside the body of raw for-loops](07-ES-Expressions+and+Statements%2Emd#Res-loop-counter)

Arithmetic rules:

* [ES.100: Don't mix signed and unsigned arithmetic](07-ES-Expressions+and+Statements%2Emd#Res-mix)
* [ES.101: Use unsigned types for bit manipulation](07-ES-Expressions+and+Statements%2Emd#Res-unsigned)
* [ES.102: Use signed types for arithmetic](07-ES-Expressions+and+Statements%2Emd#Res-signed)
* [ES.103: Don't overflow](07-ES-Expressions+and+Statements%2Emd#Res-overflow)
* [ES.104: Don't underflow](07-ES-Expressions+and+Statements%2Emd#Res-underflow)
* [ES.105: Don't divide by zero](07-ES-Expressions+and+Statements%2Emd#Res-zero)
...
**See also**: [ES.28](07-ES-Expressions+and+Statements%2Emd#Res-lambda-init)
...
For initializers of moderate complexity, including for `const` variables, consider using a lambda to express the initializer; see [ES.28](07-ES-Expressions+and+Statements%2Emd#Res-lambda-init).
...
Avoid macros if you can: [ES.30](07-ES-Expressions+and+Statements%2Emd#Res-macros), [ES.31](07-ES-Expressions+and+Statements%2Emd#Res-macros2), and [ES.32](07-ES-Expressions+and+Statements%2Emd#Res-ALL_CAPS).
...
**See also**: [Don't use a variable for two unrelated purposes](07-ES-Expressions+and+Statements%2Emd#Res-recycle)
...
If you really need to break out a loop, a `break` is typically better than alternatives such as [modifying the loop variable](07-ES-Expressions+and+Statements%2Emd#Res-loop-counter) or a [`goto`](07-ES-Expressions+and+Statements%2Emd#Res-goto):
...
(left-to-right except right-to-left in assignments, and the order of evaluation of function arguments is unspecified; [see ES.43](07-ES-Expressions+and+Statements%2Emd#Res-order)),
...
Flag `const_cast`s. See also [Type.3: Don't use `const_cast` to cast away `const` (i.e., at all)](19-Pro-Profiles%2Emd#Pro-type-constcast) for the related Profile.
...
A move typically leaves behind an empty object ([C.64](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-move-semantic)), which can be surprising or even dangerous, so we try to avoid moving from lvalues (they might be accessed later).
...
And after you do that, assume the object has been moved from (see [C.64](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-move-semantic)) and don't read its state again until you first set it to a new value.
...
**See also**: [R: Resource management](06-R-Resource+management%2Emd#S-resource).
...
This example not only violates the [no naked `new` rule](07-ES-Expressions+and+Statements%2Emd#Res-new) as in the previous example, it has many more problems.
...
The first defense against this is to [define the base class `Shape` not to allow this](04-C-Classes+and+Class+Hierarchies%2Emd#Rc-copy-virtual).
