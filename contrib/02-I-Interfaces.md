...
**Alternative**: [Pass ownership](06-R-Resource+management.md#Rr-smartptrparam) using a "smart pointer", such as `unique_ptr` (for exclusive ownership) and `shared_ptr` (for shared ownership).
...
**See also**: [Argument passing](03-F-Functions.md#Rf-conventional), [use of smart pointer arguments](06-R-Resource+management.md#Rr-smartptrparam), and [value return](#Rf-T-return).
