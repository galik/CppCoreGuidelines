...
* [I.1: Make interfaces explicit](02-I-Interfaces%2Emd#Ri-explicit)
* [I.2: Avoid global variables](02-I-Interfaces%2Emd#Ri-global)
* [I.3: Avoid singletons](02-I-Interfaces%2Emd#Ri-singleton)
* [I.4: Make interfaces precisely and strongly typed](02-I-Interfaces%2Emd#Ri-typed)
* [I.5: State preconditions (if any)](02-I-Interfaces%2Emd#Ri-pre)
* [I.6: Prefer `Expects()` for expressing preconditions](02-I-Interfaces%2Emd#Ri-expects)
* [I.7: State postconditions](02-I-Interfaces%2Emd#Ri-post)
* [I.8: Prefer `Ensures()` for expressing postconditions](02-I-Interfaces%2Emd#Ri-ensures)
* [I.9: If an interface is a template, document its parameters using concepts](02-I-Interfaces%2Emd#Ri-concepts)
* [I.10: Use exceptions to signal a failure to perform a required task](02-I-Interfaces%2Emd#Ri-except)
* [I.11: Never transfer ownership by a raw pointer (`T*`)](02-I-Interfaces%2Emd#Ri-raw)
* [I.12: Declare a pointer that must not be null as `not_null`](02-I-Interfaces%2Emd#Ri-nullptr)
* [I.13: Do not pass an array as a single pointer](02-I-Interfaces%2Emd#Ri-array)
* [I.22: Avoid complex initialization of global objects](02-I-Interfaces%2Emd#Ri-global-init)
* [I.23: Keep the number of function arguments low](02-I-Interfaces%2Emd#Ri-nargs)
* [I.24: Avoid adjacent unrelated parameters of the same type](02-I-Interfaces%2Emd#Ri-unrelated)
* [I.25: Prefer abstract classes as interfaces to class hierarchies](02-I-Interfaces%2Emd#Ri-abstract)
* [I.26: If you want a cross-compiler ABI, use a C-style subset](02-I-Interfaces%2Emd#Ri-abi)
* [I.30: Encapsulate rule violations](02-I-Interfaces%2Emd#Ri-encapsulate)

See also

* [F: Functions](03-F-Functions%2Emd#S-functions)
* [C.concrete: Concrete types](04-C-Classes+and+Class+Hierarchies%2Emd#SS-concrete)
* [C.hier: Class hierarchies](04-C-Classes+and+Class+Hierarchies%2Emd#SS-hier)
...
**References**: See the [rules for calling functions](03-F-Functions%2Emd#SS-call).
...
**References**: `Expects()` is described in [GSL](20-GSL-Guideline+support+library%2Emd#S-gsl).
...
Better still, use [RAII](06-R-Resource+management%2Emd#Rr-raii) to ensure that the postcondition ("the lock must be released") is enforced in code:
...
**Alternative**: Postconditions of the form "this resource must be released" are best expressed by [RAII](06-R-Resource+management%2Emd#Rr-raii).
...
**See also**: [Generic programming](12-T-Templates+and+generic+programming%2Emd#SS-GP) and [concepts](#SS-t-concepts).
...
* Always carefully [measure](08-Per-Performance%2Emd#Rper-measure) before making performance claims.

**See also**: [I.5](02-I-Interfaces%2Emd#Ri-pre) and [I.7](02-I-Interfaces%2Emd#Ri-post) for reporting precondition and postcondition violations.
...
**Alternative**: [Pass ownership](06-R-Resource+management%2Emd#Rr-smartptrparam) using a "smart pointer", such as `unique_ptr` (for exclusive ownership) and `shared_ptr` (for shared ownership).
...
In that case, mark owning pointers using `owner` from the [guideline support library](20-GSL-Guideline+support+library%2Emd#S-gsl):
...
**See also**: [Argument passing](03-F-Functions%2Emd#Rf-conventional), [use of smart pointer arguments](06-R-Resource+management%2Emd#Rr-smartptrparam), and [value return](#Rf-T-return).
...
`not_null` is defined in the [guideline support library](20-GSL-Guideline+support+library%2Emd#S-gsl).
...
This violated the ruly [against uninitialized variables](07-ES-Expressions+and+Statements%2Emd#Res-always),
the rule against [ignoring ownership](02-I-Interfaces%2Emd#Ri-raw),
and the rule [against magic constants](07-ES-Expressions+and+Statements%2Emd#Res-magic) .
